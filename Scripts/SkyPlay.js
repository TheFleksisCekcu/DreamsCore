...
module = {
    ...
    onPacket: function (event) {
        if ((packet = event.getPacket()) instanceof SPacketChat && packet.getChatComponent().getUnformattedText().match("Congratulations! you have won the game!")) mc.thePlayer.sendChatMessage("/sw leave"), leave = false;
    },
    onWorld: function () {
