...
module = {
    category: "Combat",
    onPacket: function (e) {
        if (e.getPacket() instanceof SPacketServerDifficulty) wasAdded = false;
        if (mc.thePlayer && e.getPacket() instanceof SPacketPlayerListItem && e.getPacket().getAction() == "ADD_PLAYER") {
